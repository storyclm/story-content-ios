...
typedef SWIFT_ENUM(NSInteger, ClosePresentationMode, open) {
...
typedef SWIFT_ENUM(NSInteger, LogAction, open) {
  LogActionOpen = 0,
  LogActionClose = 1,
  LogActionComplete = 2,
};
...
typedef SWIFT_ENUM(NSInteger, MediaFileMIMEType, open) {
...
@property (nonatomic, readonly) NSInteger presentationId;
...
///   </li>
/// </ul>
- (void)authAsServiceWithSuccess:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(SCLMError * _Nonnull))failure;
...
/// returns:
/// SCLMToken
- (void)authWithUsername:(NSString * _Nonnull)username password:(NSString * _Nonnull)password success:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(SCLMError * _Nonnull))failure;
/// Logout
/// Set token to nil and invoke logoutHandler
- (void)logout;
- (void)refreshCredentialsWithSuccess:(void (^ _Nonnull)(void))success failure:(void (^ _Nonnull)(SCLMError * _Nonnull))failure;
@end
...
- (NSArray<BridgeSession *> * _Nullable)findNotSynchronizedSessions SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, SCLMErrorType, open) {
...
typedef SWIFT_ENUM(NSInteger, SLWebViewNavigationType, open) {
